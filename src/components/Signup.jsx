...
function Signup({ onLogin, goToLogin }) {
...
<div className="mt-8">
  ...
  <div className="flex h-[42px] sm:h-[44px] items-center rounded-md border border-[#D9D9D9] bg-white px-3 sm:px-4">
    <input
      ...
      className="w-full border-none bg-transparent text-[13px] sm:text-[14px] text-[#202124] placeholder:text-[#8A8A8A] outline-none"
    />
  </div>
</div>
                        {/* Email */}
...
<div className="mt-5">
  ...
  <div className="flex h-[42px] sm:h-[44px] items-center rounded-md border border-[#D9D9D9] bg-white px-3 sm:px-4">
    <FaLock className="text-[#444] text-[13px] sm:text-[14px] flex-shrink-0" />
